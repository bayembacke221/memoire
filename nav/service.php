                ...
                <ul class="nav__list">
                    ...
                    <li class="nav__item"><a href="service.php" class="nav__link ">Services</a>
                        <div class="sub-menu-1">
                            ...
                            ?>
                                    <a href="detail.php?t=<?=$service['idService']?>" class="nav__link "><?=$service['nom']?></a><br>
                                    <?php
                            }?>
                                    <div class="sub-menu-2">
                                        <ul>
                                            ...
                                            <?php
                                                ...
                                                ?>
                                                <a href="detail.php?infoId=<?=$service2['idService']?>" class="nav__link "><?=$service2['nom']?></a><br>
                                                <?php
                                                }?>
                                            </ul>
                                    </div>
                    ...
                    foreach($stmts as $stmt){ 
                        ...
                        <div style="margin-right: 5%;background-color: #393939;" class="menu__content" >
                            ...
                            <h3 style="color: #fff;" class="menu__name"><?= $stmt['domain']?></h3><br>
                                <a class="nav__link" href="detail.php?t=<?= $idserv;?>"> <i style="color:#069C54;" data-bs-toggle="modal" data-bs-target="#valider" class="bx bxs-right-arrow-alt"> Voir</i></a>
                        </div>
