              ...
              <form method="POST" enctype="multipart/form-data" action="modifier.php">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input style="color:black" type="text" name="username" id="input-username" class="form-control form-control-alternative"  value="<?=$user['username']?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input style="color:black" type="file" name="photo" id="input-last-name" class="form-control form-control-alternative" >
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input style="color:black" type="text" disabled name="profession" id="input-country" class="form-control form-control-alternative" value="<?=$user['profession']?>">
                      </div>
                    </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group focused">
                    ...
                    <textarea style="color:black" rows="4" name="propos" class="form-control form-control-alternative" placeholder="" value=""><?=$user['propos']?></textarea>
                  </div>
                </div>
