...
if (isset($_SESSION['numero']) ) {
    ...
    $idE = (int) trim($_GET['idPrestataire']);
    $id = (int) trim($_GET['idClient']);
    if (isset($_POST['msg'])) {
    ...
    $req->execute(array($_SESSION['numero'],$id,$id,$_SESSION['numero']));
        ...
        <nav class="nav bd-container">
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item"><a href="consulterOffre.php" class="nav__link">Consulter les demandes</a></li>
    ...
    <div style="width:60%;margin-top:10%;margin-left:20% " class="nav-top">
            ...
            <div class="utilisateur">
                ...
                <div class="d-flex align-items-center">
                    <img style="max-width:50%" src=".."class="card-img  rounded-circle">
                </div>
                <p id="prenom"></p> 
                <p id="nom"> </p> 
            </div>
